...
class AM_Enc2(nn.Module):
    """ Encoder - network architecture """
    def __init__(self, nChannels, args, cnn_kwargs):
        super(AM_Enc2, self).__init__()  # inheritance used here.
        self.args = args
...
class AM_Dec2(nn.Module):
    """ Decoder - network architecture """
    def __init__(self, nChannels, args, cnn_kwargs):
        super(AM_Dec2, self).__init__()
        self.args = args
        self.main = nn.Sequential(
...
class AM_RKM_Stiefel2(nn.Module):
    ...
    def __init__(self, ipVec_dim, args, nChannels=1, recon_loss=nn.MSELoss(reduction='sum'), ngpus=1):
        super(AM_RKM_Stiefel2, self).__init__()
        ...
        self.encoder = AM_Enc2(self.nChannels, self.args, self.cnn_kwargs)
        self.decoder = AM_Dec2(self.nChannels, self.args, self.cnn_kwargs)
